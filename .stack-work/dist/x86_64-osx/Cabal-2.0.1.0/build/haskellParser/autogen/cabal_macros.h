...
/* package haskellParser-0.1.0.0 */
#ifndef VERSION_haskellParser
#define VERSION_haskellParser "0.1.0.0"
#endif /* VERSION_haskellParser */
#ifndef MIN_VERSION_haskellParser
#define MIN_VERSION_haskellParser(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskellParser */
...
#define CURRENT_COMPONENT_ID "haskellParser-0.1.0.0-FRI79JBN96745kIAs6swz5-haskellParser"
